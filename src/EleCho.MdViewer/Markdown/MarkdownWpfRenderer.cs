...
public class MarkdownWpfRenderer
{
    ...
    public WpfDocs.Inline RenderTaskListInline(TaskList taskListInline, CancellationToken cancellationToken)
    {
        ...
        box.SetResourceReference(FrameworkElement.StyleProperty,ControlStyleKey.CheckBoxStyle);

        return box.WrapWithContainer(); ;
    }
    ...
    public WpfDocs.Inline RenderLinkInline(LinkInline linkInline, CancellationToken cancellationToken)
    {
        ...
        {
            WpfDocs.Hyperlink link = new();
            link.SetResourceReference(FrameworkContentElement.StyleProperty, ControlStyleKey.HyperlinkStyle);
